...
mixin _$ResponseModel {
  @JsonKey(name: "status")
  String? get statue => throw _privateConstructorUsedError;
  @JsonKey(name: "msg")
...
class _$ResponseModelCopyWithImpl<$Res, $Val extends ResponseModel>
  ...
  @override
  $Res call({
    Object? statue = freezed,
    Object? msg = freezed,
    Object? body = freezed,
  }) {
    return _then(_value.copyWith(
      statue: freezed == statue
          ? _value.statue
          : statue // ignore: cast_nullable_to_non_nullable
              as String?,
      msg: freezed == msg
          ? _value.msg
...
class _$ResponseModelImpl implements _ResponseModel {
  const _$ResponseModelImpl(
      {@JsonKey(name: "status") this.statue,
  ...
  @override
  String toString() {
    return 'ResponseModel(statue: $statue, msg: $msg, body: $body)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.statue, statue) || other.statue == statue) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, statue, msg, body);
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel(
      {@JsonKey(name: "status") final String? statue,
      @JsonKey(name: "msg") final String? msg,
      @JsonKey(name: "body") final String? body}) = _$ResponseModelImpl;
